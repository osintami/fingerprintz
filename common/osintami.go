...
func NewOSINTAMIClient(client *resty.Client, nodsURL string, whoamiURL string) *OSINTAMIClient {
	return &OSINTAMIClient{client: client, nodsURL: nodsURL, whoamiURL: whoamiURL}
}

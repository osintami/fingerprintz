...
func NewGatewayServer(proxy IProxy, oc common.IOsintami, cache common.IFastCache, accounts IAccounts, calls ICalls, pixels IPixels, gws IGatewayServices) *GatewayServer {
